...
/**
 * SDK v2 AttributeConverter that wraps Instant2IsoDynamoDBMarshaller for SDK_V1_COMPATIBLE mode.
...
public class Instant2IsoAttributeConverter implements AttributeConverter<Instant> {
     ...
     * Default constructor.
     */
    public Instant2IsoAttributeConverter() {
    }

    private final Instant2IsoDynamoDBMarshaller marshaller = new Instant2IsoDynamoDBMarshaller();
