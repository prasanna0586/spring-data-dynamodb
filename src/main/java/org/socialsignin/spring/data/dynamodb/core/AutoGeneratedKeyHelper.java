...
public class AutoGeneratedKeyHelper {
    ...
    private static <T> void processUuidMethod(T entity, Method getter) throws ReflectiveOperationException {
    ...
    private static <T> void processTimestampMethod(T entity, Method getter) throws ReflectiveOperationException {
        Object currentValue = getter.invoke(entity);
