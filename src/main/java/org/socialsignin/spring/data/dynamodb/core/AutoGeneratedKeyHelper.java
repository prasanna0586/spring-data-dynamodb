...
public class AutoGeneratedKeyHelper {
     ...
     */
    public static <T> void processAutoGeneratedKeys(T entity) {
        if (entity == null) {
            return;
        }
    ...
    private static <T> void processFields(T entity, Class<?> clazz) {
    ...
    private static <T> void processMethods(T entity, Class<?> clazz) {
    ...
    private static <T> void processUuidField(T entity, Field field) throws IllegalAccessException {
    ...
    private static <T> void processTimestampField(T entity, Field field) throws IllegalAccessException {
        field.setAccessible(true);
        Object currentValue = field.get(entity);
    ...
    private static <T> void processUuidMethod(T entity, Method getter) throws Exception {
        ...
        if (currentValue == null || (currentValue instanceof String && ((String) currentValue).isEmpty())) {
            if (getter.getReturnType() == String.class) {
                ...
                if (setter != null) {
                    ...
                    LOGGER.warn("No setter found for getter {}", getter.getName());
                }
            }
        }
    }

    private static <T> void processTimestampMethod(T entity, Method getter) throws Exception {
        Object currentValue = getter.invoke(entity);
    ...
    private static boolean hasAnnotation(Field field, String annotationClassName) {
        return field.getAnnotations() != null &&
               java.util.Arrays.stream(field.getAnnotations())
