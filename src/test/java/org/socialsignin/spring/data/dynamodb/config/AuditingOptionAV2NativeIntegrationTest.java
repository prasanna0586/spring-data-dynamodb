...
@ContextConfiguration(classes = { DynamoDBLocalResource.class,
        AuditingOptionAV2NativeIntegrationTest.TestAppConfig.class })
@TestPropertySource(properties = { "spring.data.dynamodb.entity2ddl.auto=create" })
public class AuditingOptionAV2NativeIntegrationTest {
    ...
    public static class TestAppConfig {
        ...
        public DynamoDBMappingContext dynamoDBMappingContext() {
            return new DynamoDBMappingContext(MarshallingMode.SDK_V2_NATIVE);
        }
    }
    ...
    @Test
    public void auditingWithExplicitBeanV2Native() {
