...
public class AuditingViaJavaConfigRepositoriesIntegrationTest {
    ...
    public void setUp() {
        ...
        // Create and save an auditor (ID will be auto-generated)
    ...
    @Test
    public void basicAuditingWithAutoGeneratedId() {
        // Set the current auditor to the saved auditor's ID
        auditorAware.setCurrentAuditor(this.auditor.getId());

        // Create and save user (ID will be auto-generated in SDK_V1_COMPATIBLE mode)
