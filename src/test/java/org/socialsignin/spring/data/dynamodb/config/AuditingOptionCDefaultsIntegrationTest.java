...
/**
 * Integration tests for auditing with default configuration (Option C).
 *
 * Configuration Option C: Accept all defaults
...
@ContextConfiguration(classes = { DynamoDBLocalResource.class,
        AuditingOptionCDefaultsIntegrationTest.TestAppConfig.class })
@TestPropertySource(properties = { "spring.data.dynamodb.entity2ddl.auto=create" })
public class AuditingOptionCDefaultsIntegrationTest {
    ...
    public static class TestAppConfig {
        ...
        // No explicit DynamoDBMappingContext bean - accepts default SDK_V2_NATIVE
    }
    ...
    @Test
    public void auditingWithDefaults() {
