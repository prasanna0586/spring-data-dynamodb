...
/**
 * Comprehensive type converter integration test for SDK_V1_COMPATIBLE mode.
 *
...
@ContextConfiguration(classes = {DynamoDBLocalResource.class, TypeConverterV1CompatibleIntegrationTest.TestAppConfig.class})
@TestPropertySource(properties = {"spring.data.dynamodb.entity2ddl.auto=create"})
@DisplayName("Type Converter Tests - V1_COMPATIBLE Mode")
public class TypeConverterV1CompatibleIntegrationTest {

    private static final Logger logger = LoggerFactory.getLogger(TypeConverterV1CompatibleIntegrationTest.class);
